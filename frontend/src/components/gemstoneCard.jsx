...
const GemstoneCard = ({ color, products }) => {
	...
	return (
		<div>
			...
			{totalPages > 1 && (
				<div className="flex flex-nowrap justify-center items-center gap-1 sm:gap-3 my-6 px-1 w-full">
					<button
						...
						{visiblePagesMobile.map((page, idx) =>
							typeof page !== "number" ? (
								...
								<button
									...
									className={`px-1.5 py-1 rounded shrink-0 text-[11px] ${currentPage === page
