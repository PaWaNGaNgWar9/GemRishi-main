                        ...
                        <div class="space-y-7">
                            ...
                            <div>
                                ...
                                <textarea name="excerpt"
                                        ...
                                        class="w-full px-6 py-5 rounded-2xl border border-zinc-300 bg-zinc-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-green-900 resize-none">{{ old('excerpt', $blog->excerpt) }}</textarea>
...
<script>
    ...
    */
    ...
    let oldContent = `{!! old('content', $blog->content) !!}`;
