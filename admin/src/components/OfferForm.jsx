...
const OfferForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const newErrors = {};
    if (!offerData.name) newErrors.name = "Please provide offer name";
    if (!offerData.discountValue)
      newErrors.discountValue = "Please provide Discount";
    ...
    if (!offerData.discountType)
      newErrors.discountType = "Please provide Discount type";
    if (!offerData.offerType) newErrors.offerType = "Please provide Offer type";
    if (!offerData.productType)
      newErrors.productType = "Please provide Product type";
    ...
    try {
      const res = await createOffer(offerData).unwrap();
  ...
  return (
    <form
      ...
      className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl shadow-lg p-8 w-full mx-auto"
    >
      <div className="flex justify-between">
        <h2 className="col-span-2 text-3xl font-bold mb-8 text-slate-900 tracking-tight">
          Create New Offer
        </h2>
        ...
        <div>
          <Button
            ...
            className="bg-[#214436] text-white"
          >
            Offer list
          </Button>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          />
          {errors.description ? (
            <span className="text-sm text-red-800">{errors.description}</span>
          ) : (
            ""
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          {errors.expiryDate ? (
            <span className="text-sm text-red-800">{errors.expiryDate}</span>
          ) : (
            ""
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          {errors.offerType ? (
            <span className="text-sm text-red-800">{errors.offerType}</span>
          ) : (
            ""
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          {errors.productType ? (
            <span className="text-sm text-red-800">{errors.productType}</span>
          ) : (
            ""
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          {errors.discountType ? (
            <span className="text-sm text-red-800">{errors.discountType}</span>
          ) : (
            ""
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          {errors.discountValue ? (
            <span className="text-sm text-red-800">{errors.discountValue}</span>
          ) : (
            ""
          )}
        </div>
      ...
      <div className="flex justify-end mt-8 pt-6 border-t border-slate-200">
        <button
          type="submit"
          className="bg-[#214436] text-white hover:bg-emerald-700 font-semibold px-8 py-3 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg active:scale-95"
        >
          Save Offer
        </button>
      </div>
