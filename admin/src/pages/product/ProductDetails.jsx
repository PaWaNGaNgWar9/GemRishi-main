...
function ProductDetails() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      toast.error(error?.data?.msg || error?.data?.message || error?.error || "Product deleted successfully");
    }
  };
...
{/* ################################################################################################################################### */}
                  {/* <div className="p-6 border-t border-gray-100 ">
                        ...
                        <ul className="list-disc list-inside text-sm mt-2">
                          {[
                              { name: "Blue Sapphire Premium", price: "₹ 12,500" },
                              { name: "Ruby Natural Stone", price: "₹ 18,900" },
                              { name: "Emerald Zambian", price: "₹ 9,750" },
                          ].map((item, index) => (
                            <li
                              key={index}
