...
function JewelleryCategoryEditPage() {
  ...
  const { data: subcategory, isLoading: subcategoryLoading } =
    useGetSingleJewellerySubCategoryQuery({slug, page: 1, limit: 10});
  ...
  useEffect(() => {
    if (subcategory?.subcategory) {
      setFormData({
        ...
        buyerGuide: product.buyerGuide || "",
        qualityAndPrice: product.qualityAndPrice || "",
        about: product.about || "",
  ...
  useEffect(() => {
    if (product?.jewelryCategory) {
      setSelectedCategoryId(product.jewelryCategory);
    }
  }, [product]);
  ...
  const handleSave = async () => {
    try {
      ...
      data.append("buyerGuide", formData.buyerGuide);
      data.append("qualityAndPrice", formData.qualityAndPrice);
      data.append("meaning", formData.meaning);
      data.append("faqs", JSON.stringify(formData.faqs));
      data.append("jewelryCategory", selectedCategoryId);

      data.append("subCategoryImg", img);

      // Call API mutation
      const res = await updateCategory({
        jewelrysubCategoryId: product._id,
        formData: data,
      })
        .unwrap()
        .then((res) => {
          navigate(`/jewellery-category/${res.newSlug}`, { replace: true });
        });

      toast.success("Jewellery Category Edited Successfully");
    } catch (error) {
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        {category?.jewelryCategories?.map((sub) => (
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div>
                      ...
                      <Textarea
                        name="qualityAndPrice"
                        type="text"
                        value={formData.qualityAndPrice}
                        onChange={handleInputChange}
                        placeholder="Quality & Price Description"
                        rows={6}
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div>
                      ...
                      <Textarea
                        name="buyerGuide"
                        value={formData.buyerGuide}
                        onChange={handleInputChange}
                        rows={6}
                        placeholder="Enter Buyerguide..."
                      />
                    </div>
                  </div>
...
export default JewelleryCategoryEditPage;
