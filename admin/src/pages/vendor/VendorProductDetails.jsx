          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center gap-3">
              <motion.button
                ...
                onClick={() => navigate(`/edit-details/${product.slug}`)}
              >
                <img
              ...
              <CardContent>
                ...
                <div>
                  ...
                  <div className="flex justify-end gap-4 px-6 pb-6">
                    <button
                      onClick={() => navigate(-1)} // go back to prev page
                      className="w-1/2 px-4 py-2 rounded-lg border border-gray-500 text-gray-700 hover:bg-gray-100 transition-colors cursor-pointer"
                    >
                      Back
                    </button>
                    <button
                      className="w-1/2 px-4 py-2 rounded-lg bg-[#264A3F] text-white transition-colors cursor-pointer"
                    >
                      Buy-back
                    </button>
                  </div>
